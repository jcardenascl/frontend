# Contributing to Expense Tracker Frontend

First and foremost, thank you! We appreciate that you want to contribute to expense-tracker-frontend, your time is valuable, and your contributions mean a lot to us.
...
Don't have time to contribute? No worries, here are some other ways to show your support for expense-tracker-frontend:

- star the [project](https://github.com/danestves/expense-tracker-frontend)
- tweet your support for Expense Tracker
...
- **version**: (required) please note the version of expense-tracker-frontend are you using
- **error messages**: (required) please paste any error messages into the issue, or a [gist](https://gist.github.com/)
- **extensions, plugins, helpers, etc** (if applicable): please list any extensions you're using

### Closing issues

The original poster or the maintainers of expense-tracker-frontend may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/expense-tracker-frontend
